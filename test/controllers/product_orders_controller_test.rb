...
class ProductOrdersControllerTest < ActionController::TestCase
  ...
  test "should create product_order" do
    assert_difference('ProductOrder.count') do
      post :create, product_order: { order_id: @product_order.order_id, price_per_quantity: @product_order.price_per_quantity, product_id: @product_order.product_id, quantity: @product_order.quantity }
    end
  ...
  test "should update product_order" do
    patch :update, id: @product_order, product_order: { order_id: @product_order.order_id, price_per_quantity: @product_order.price_per_quantity, product_id: @product_order.product_id, quantity: @product_order.quantity }
    assert_redirected_to product_order_path(assigns(:product_order))
  end
